...
//        Config();
//        all();
//        List list = Collections.unmodifiableList(Arrays.asList(List.of(1,2,3)));
////        list.add(4);
//        list.stream().forEach((v)-> System.out.println(v));
//        var str = "fdsfads";
//        var count = 1;
//        System.out.println(count+str);
//        String ss = "lyf@xyd.cn";
//        String s = ss.replaceAll("[@.?'“”]","");
//        String sss = "-";
//        System.out.println((int)sss.toCharArray()[0]);
//        System.out.println(s);
//        Persion persion = new Persion();
//        persion.setName("ffff");
//        test(persion);
//        System.out.println(persion+"---"+persion.getName());
//        String[] ss = "fdsfsdf".split(",");
//        System.out.println(((1/2)*100)+"%");
//        BigDecimal app = new BigDecimal("0.00");
//        BigDecimal total = new BigDecimal("0.00");
////        System.out.println(app.divide(total,2,BigDecimal.ROUND_HALF_DOWN).multiply(new BigDecimal(100)));
//        for (int i = 0; i<2;i++){
//            BigDecimal dd = new BigDecimal("200.00");
//            app = app.add(dd);
//        }
//        System.out.println(app);

        try {
            Timestamp date = getQueryEndTime18Or24("24",new SimpleDateFormat("yyyy-MM-dd").parse("2018-09-14") );
    ...
    public static void test(Persion persion){
        Persion persion1 = new Persion();
        persion = persion1;
        persion.setName("dfsf");
        System.out.println(persion+"--"+persion1+" name:"+persion.getName()+" name1:"+persion1.getName());
    }


    private static Timestamp getQueryEndTime18Or24(String judge, Date time) {
        Calendar cal_end = Calendar.getInstance();
        cal_end.setTime(time);
        if ("18".equals(judge)) {
            cal_end.set(Calendar.HOUR_OF_DAY, 18); //时
            cal_end.set(Calendar.MINUTE, 00); // 分
            cal_end.set(Calendar.SECOND, 01); // 秒
        } else {
            cal_end.set(Calendar.HOUR_OF_DAY, 23);
            cal_end.set(Calendar.MINUTE, 59);
            cal_end.set(Calendar.SECOND, 59);
        }
        return new Timestamp(cal_end.getTimeInMillis());
    }
}
